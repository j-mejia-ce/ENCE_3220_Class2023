...
#define DIGIT_1   13
 ...
 // redid char table with binary values because we couldn't
 // figure out which hex values were impacting our  display
unsigned char table[]=
{ 0b00111111, // 0
  0b00000110, // 1
  0b01011011, // 2
...
// values for counter and initilization
...
void setup() {
 // LEDs Pins
  ...
  // initialize timer1 
  // single interrupt setup - later versions may include another
...
// function for displaying each of the four 7-segments
// each value is based on the countdown and the initial time
...
// four different display functions to activate each 7-segment seperately
void disp_on1()
{
